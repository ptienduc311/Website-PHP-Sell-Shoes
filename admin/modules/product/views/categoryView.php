<?php
get_header();
// $list_data_cat = show_data_cat_by_parent_id();
?>
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=product&controller=cat&action=addCat" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
